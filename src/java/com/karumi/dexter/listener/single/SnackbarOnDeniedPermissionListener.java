 ...
 *  com.karumi.dexter.listener.single.SnackbarOnDeniedPermissionListener$1
 *  java.lang.String
 */
...
extends BasePermissionListener {
    ...
    private SnackbarOnDeniedPermissionListener(View view, String string, String string2, View.OnClickListener onClickListener, Snackbar.Callback callback, int n) {
        this.view = view;
        this.text = string;
    ...
    public /* synthetic */ SnackbarOnDeniedPermissionListener(View view, String string, String string2, View.OnClickListener onClickListener, Snackbar.Callback callback, int n, 1 var7_7) {
