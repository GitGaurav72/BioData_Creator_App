 ...
 *  com.karumi.dexter.listener.multi.SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener$1
 *  java.lang.String
 */
...
import com.karumi.dexter.listener.multi.SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener;
...
extends BaseMultiplePermissionsListener {
    ...
    private SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener(View view, String string, String string2, View.OnClickListener onClickListener, Snackbar.Callback callback, int n) {
        this.view = view;
        this.text = string;
    ...
    public /* synthetic */ SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener(View view, String string, String string2, View.OnClickListener onClickListener, Snackbar.Callback callback, int n, 1 var7_7) {
