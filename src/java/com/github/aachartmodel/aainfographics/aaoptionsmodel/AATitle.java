...
public final class AATitle {
    ...
    public final AATitle text(String string2) {
        this.text = string2;
        return this;
    }

    public final AATitle userHTML(Boolean bl) {
        this.userHTML = bl;
        return this;
    }
