...
extends s0 {
    ...
    public final ExecutorService B() {
        ...
        return Executors.newFixedThreadPool((int)this.I(), (ThreadFactory)new b(atomicInteger));
    }
     ...
     */
    @Override
    public void dispatch(f var1_1, Runnable var2_2) {
        try {
            var3_3 = q.pool;
        ...
        q.pool = var3_3 = this.F();
lbl-1000: // 3 sources:
        {
            var3_3.execute(var2_2);
            return;
        }
    }
