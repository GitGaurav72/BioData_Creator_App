...
implements Serializable {
    ...
    public d(String string) {
        ...
        i.d((Object)pattern, "compile(pattern)");
        i.e((Object)pattern, "nativePattern");
        this.k = pattern;
    }

    public final boolean a(CharSequence charSequence) {
        i.e((Object)charSequence, "input");
    ...
    public final String b(CharSequence charSequence, String string) {
        ...
        String string2 = this.k.matcher(charSequence).replaceAll(string);
        i.d(string2, "nativePattern.matcher(in\u2026).replaceAll(replacement)");
        return string2;
    }

    public String toString() {
        String string = this.k.toString();
        i.d(string, "nativePattern.toString()");
        return string;
    }
}
